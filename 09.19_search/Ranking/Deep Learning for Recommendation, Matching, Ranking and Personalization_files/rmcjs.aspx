...
var rmc = {
    ...
    Share: function (s, u) {
        ...
        switch (s) {
            ...
            // Weibo
            case "1":
                this.Open("/apps/c/1470.aspx?url=" + u + "&title=" + escape(document.title), n, "");
                break;
            // Renren
            case "2":
                this.Open("/apps/c/1471.aspx?url=" + u + "&title=" + escape(document.title), n, "");
                break;
            // LinkedIn
            case "3":
                this.Open("/apps/c/1472.aspx?url=" + u + "&title=" + escape(document.title), n, "");
                break;
            // Email
            case "4":
                this.Open("/apps/c/1473.aspx?url=" + u + "&title=" + escape(document.title), n, "");
                break;
            // Facebook Share  
            case "F":
    ...
    WeChat: {
        Open: function () {
            ...
            if (cci != null) { cci.src = "/c/1464"; }
            $("#pageShade").show();
            $("#wcHolder").show().animate({ height: "450px", width: "450px", "margin-top": "-225px", "margin-left": "-225px" }, 1000, function () { $("#wcHolder > div > img").show(); $("#wcHolder > img").show(); });
        },
        Close: function () {
            $("#wcHolder > div > img").hide();
            $("#wcHolder > img").hide();
            $("#wcHolder").animate({ height: "0px", width: "0px", "margin-top": "0px", "margin-left": "0px" }, 1000, function () { $("#qrHolder").hide(); $("#pageShade").hide(); });
        }
    }
};
